...
# Use confirmed best parameters from GridSearchCV
best_params = {
    'C': 0.1,
    'gamma': 0.001,
    'kernel': 'rbf'
...
print(f"Train-Test Split Accuracy (Top 10 Features, Tuned SVM): {accuracy_split * 100:.2f}%")

#10-Fold Cross Validation
clf_cv = SVC(**best_params)
cv_scores = cross_val_score(clf_cv, X_selected, y, cv=10)
print("\n10-Fold Cross-Validation Accuracies (Top 10 Features, Tuned SVM):")
